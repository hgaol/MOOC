...
def getCountsAndAverages(IDandRatingsTuple):
    ...
    tot_rating = 0.0
    for item in IDandRatingsTuple[1]:
        tot_rating += item
    return (IDandRatingsTuple[0], (cnt, tot_rating / cnt))
...
myRatedMovies = [
     (myUserID, 5, 5), (myUserID, 15, 5), (myUserID, 25, 5), (myUserID, 35, 5), (myUserID, 555, 5), (myUserID, 705, 5), (myUserID, 1105, 5),
     (myUserID, 1982, 1),
